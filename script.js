document.addEventListener('DOMContentLoaded', () => {
    ...
    const data = [
        ...
        { '自分の視点': '守り側 / 被起き攻め', '相手の行動': '投げ重ね', '相手の行動 分類': '投げ系', '相手の行動 基本': '基本', '自分の行動': 'とんおり系の技', '自分の行動 分類': '無敵・防御系', '自分の行動 基本': '', '評価点': '◎', '詳細・評価の根拠': '投げ重ねに対して特大リターンを生む。' },
        { '自分の視点': '守り側 / 被起き攻め', '相手の行動': '投げ重ね', '相手の行動 分類': '投げ系', '相手の行動 基本': '基本', '自分の行動': 'バクステ', '自分の行動 分類': '回避・移動系', '自分の行動 基本': '基本', '評価点': '○', '詳細・評価の根拠': '投げ無敵を利用して投げを回避し、相手の投げスカりに反撃できる。画面端では反撃を狙いやすい。' },
        { '自分の視点': '守り側 / 被起き攻め', '相手の行動': '投げ重ね', '相手の行動 分類': '投げ系', '相手の行動 基本': '基本', '自分の行動': 'バックジャンプ', '自分の行動 分類': '回避・移動系', '自分の行動 基本': '基本', '評価点': '○', '詳細・評価の根拠': 'ジャンプで投げを回避し、相手の投げスカりに反撃できる。' },
        ...
        { '自分の視点': '守り側 / 被起き攻め', '相手の行動': 'シミー', '相手の行動 分類': '揺さぶり・投げ抜け系', '相手の行動 基本': '基本', '自分の行動': '打撃暴れ※', '自分の行動 分類': '打撃系', '自分の行動 基本': '基本', '評価点': '○', '詳細・評価の根拠': 'コパン：△ 中足：◎ コパンはとくに相手に100%ダメージを通せるわけではなく、リスクを背負ってガードさせる意味は薄い。' },
        { '自分の視点': '守り側 / 被起き攻め', '相手の行動': 'シミー', '相手の行動 分類': '揺さぶり・投げ抜け系', '相手の行動 基本': '基本', '自分の行動': 'とんおり系の技', '自分の行動 分類': '無敵・防御系', '自分の行動 基本': '', '評価点': '✕', '詳細・評価の根拠': 'シミーされた場合、とんおり系の技はガードされ、確定反撃または不利フレームを背負ってしまいます。' },
